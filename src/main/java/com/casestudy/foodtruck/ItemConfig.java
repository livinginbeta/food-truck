...
public class ItemConfig {
    ...
    public void setup() {
        ...
        itemService.create(new Item(6L, "Taiyaki", "This traditional Japanese treat is made with waffle batter and filled with red bean paste and either custard or cheese. Cho oishii!", 1.00));
